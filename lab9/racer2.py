...
speed = 1
score = 0
enemy_speed_increment = 0.1  # Increment of enemy speed when the player earns N coins
coins_to_increment_speed = 5  # Number of coins to earn before increasing enemy speed
...
while running:
    ...
    for coin in coin_group:
        ...
        if pygame.sprite.collide_rect(player, coin):
            coin.kill()
            score += 10
            if score % coins_to_increment_speed == 0:  # Increase enemy speed when the player earns N coins
